 ...
 */
public class OrthologueFinderNodePlugin extends Plugin {
    // The shared instance.
    private static OrthologueFinderNodePlugin plugin;

    /**
     * The constructor.
     */
    public OrthologueFinderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static OrthologueFinderNodePlugin getDefault() {
        return plugin;
    }
