 ...
 */
public class VennAnalyzerNodePlugin extends Plugin {
    // The shared instance.
    private static VennAnalyzerNodePlugin plugin;

    /**
     * The constructor.
     */
    public VennAnalyzerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static VennAnalyzerNodePlugin getDefault() {
        return plugin;
    }
