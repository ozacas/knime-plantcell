...
/**
 * <code>NodeDialog</code> for the "XTandemReader" Node.
 ...
 */
public class XTandemReaderNodeDialog extends DefaultNodeSettingsPane {
	private final SettingsModelStringArray file_list = new SettingsModelStringArray(XTandemReaderNodeModel.CFGKEY_FILES, new String[] { "" });

    /**
     * New pane for configuring XTandemReader node dialog.
     * This is just a suggestion to demonstrate possible default dialog
     * components.
     */
    protected XTandemReaderNodeDialog() {
        super();
        ...
        final JButton add_button = new JButton("Add XTandem! results...");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				FileFilter filter = new FileFilter() {
					...
					public boolean accept(File arg0) {
						...
						if (fname.endsWith(".xml") || fname.endsWith(".gaml")) {
							return true;
						}
						return false;
					}
					...
					public String getDescription() {
						return "XTandem results (.xml, .gaml)";
					}
				};
        ...
        this.addTab("Options", file_panel);
    }
