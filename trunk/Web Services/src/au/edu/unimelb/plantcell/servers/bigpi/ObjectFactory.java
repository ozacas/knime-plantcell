 ...
 * generated in the au.edu.unimelb.plantcell.servers.bigpi package. 
...
public class ObjectFactory {
    ...
    private final static QName _SubmitProteinSequenceAsFasta_QNAME = new QName("http://nectar.plantcell.unimelb.edu.au", "protein_sequence_as_fasta");
    private final static QName _SubmitOrganismType_QNAME = new QName("http://nectar.plantcell.unimelb.edu.au", "organism_type");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.unimelb.plantcell.servers.bigpi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nectar.plantcell.unimelb.edu.au", name = "protein_sequence_as_fasta", scope = Submit.class)
    public JAXBElement<String> createSubmitProteinSequenceAsFasta(String value) {
        return new JAXBElement<String>(_SubmitProteinSequenceAsFasta_QNAME, String.class, Submit.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nectar.plantcell.unimelb.edu.au", name = "organism_type", scope = Submit.class)
    public JAXBElement<String> createSubmitOrganismType(String value) {
        return new JAXBElement<String>(_SubmitOrganismType_QNAME, String.class, Submit.class, value);
    }
