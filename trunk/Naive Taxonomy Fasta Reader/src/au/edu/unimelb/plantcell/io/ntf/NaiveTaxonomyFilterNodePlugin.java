 ...
 */
public class NaiveTaxonomyFilterNodePlugin extends Plugin {
    // The shared instance.
    private static NaiveTaxonomyFilterNodePlugin plugin;

    /**
     * The constructor.
     */
    public NaiveTaxonomyFilterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static NaiveTaxonomyFilterNodePlugin getDefault() {
        return plugin;
    }
