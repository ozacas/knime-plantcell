 ...
 */
public class MultiExcelReaderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.edu.unimelb.plantcell.io.read.multiexcel.StringMatcher";

    // The shared instance.
    private static MultiExcelReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public MultiExcelReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MultiExcelReaderNodePlugin getDefault() {
        return plugin;
    }
