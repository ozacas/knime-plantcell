 ...
 */
public class StringFinderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.stringmatcher";

    // The shared instance.
    private static StringFinderNodePlugin plugin;

    /**
     * The constructor.
     */
    public StringFinderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static StringFinderNodePlugin getDefault() {
        return plugin;
    }
