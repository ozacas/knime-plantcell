 ...
 */
public class MascotReaderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.edu.unimelb.plantcell.io.read.mascot";

    // The shared instance.
    private static MascotReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public MascotReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MascotReaderNodePlugin getDefault() {
        return plugin;
    }
