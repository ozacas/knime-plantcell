 ...
 */
public class XMLReaderNodePlugin extends Plugin {
    // The shared instance.
    private static XMLReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public XMLReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static XMLReaderNodePlugin getDefault() {
        return plugin;
    }
