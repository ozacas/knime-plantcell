...
/**
 * This is the model implementation of MakeCluster.
 ...
 */
public class MakeClusterNodeModel extends NodeModel {
    
    // the logger instance
    private static final NodeLogger logger = NodeLogger
            .getLogger(MakeClusterNodeModel.class);
    ...
    private final SettingsModelIntegerBounded m_count =
        new SettingsModelIntegerBounded(MakeClusterNodeModel.CFGKEY_COUNT,
     ...
     */
    protected MakeClusterNodeModel() {
