...
public class ResidueAnalysisTask extends BioJavaProcessorTask {
	...
	public DataColumnSpec[] getColumnSpecs() {
		...
		cols[0] = new DataColumnSpecCreator("Neutral residues", IntCell.TYPE).createSpec();
		cols[1] = new DataColumnSpecCreator("Non-polar residues", IntCell.TYPE).createSpec();
		cols[2] = new DataColumnSpecCreator("Slightly polar residues (C&W)", IntCell.TYPE).createSpec();
		cols[3] = new DataColumnSpecCreator("Polar residues", IntCell.TYPE).createSpec();
		cols[4] = new DataColumnSpecCreator("Basic residues", IntCell.TYPE).createSpec();
		cols[5] = new DataColumnSpecCreator("Acidic residues", IntCell.TYPE).createSpec();
		cols[6] = new DataColumnSpecCreator("Other", IntCell.TYPE).createSpec();
		cols[7] = new DataColumnSpecCreator("Non-polar and hydrophobic residues", IntCell.TYPE).createSpec();
		cols[8] = new DataColumnSpecCreator("Polar and hydrophilic residues", IntCell.TYPE).createSpec();
		cols[9] = new DataColumnSpecCreator("Uncharged polar hydrophilic residues", IntCell.TYPE).createSpec();
		cols[10]= new DataColumnSpecCreator("Charged polar hydrophilic residues", IntCell.TYPE).createSpec();
		cols[11]= new DataColumnSpecCreator("Positively charged polar hydrophilic residues", IntCell.TYPE).createSpec();
		cols[12]= new DataColumnSpecCreator("Negatively charged polar hydrophilic residues", IntCell.TYPE).createSpec();
		return cols;
	}
