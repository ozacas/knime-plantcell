 ...
 * 
 */
@WebServiceClient(name = "JDispatcherService", targetNamespace = "http://soap.jdispatcher.ebi.ac.uk", wsdlLocation = "file:/C:/Users/andrew.cassin/AppData/Local/Temp/tempdir2066631269874272004.tmp/tcoffee_1.wsdl")
public class JDispatcherService_Service
    extends Service
{

    private final static URL JDISPATCHERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(uk.ac.ebi.jdispatcher.soap.tcoffee.JDispatcherService_Service.class.getName());

    static {
        URL url = JDispatcherService_Service.class.getClassLoader().getResource("wsdl/tcoffee.wsdl");
        if (url == null) {
        	logger.info("Could not load WSDL for TCoffee: node may not work (but will try anyway)");
        }
