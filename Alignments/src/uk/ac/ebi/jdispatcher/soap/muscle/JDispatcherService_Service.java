 ...
 * 
 */
@WebServiceClient(name = "JDispatcherService", targetNamespace = "http://soap.jdispatcher.ebi.ac.uk", wsdlLocation="http://localhost/wsdl/muscle.wsdl")
public class JDispatcherService_Service
    extends Service
{

    private final static URL JDISPATCHERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(uk.ac.ebi.jdispatcher.soap.muscle.JDispatcherService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = JDispatcherService_Service.class.getResource(".");
            url = new URL(baseUrl, "http://localhost/wsdl/muscle.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost/wsdl/muscle.wsdl', retrying as a local file");
