 ...
 */
public class MultiAlignerNodePlugin extends Plugin {
    // The shared instance.
    private static MultiAlignerNodePlugin plugin;
    
    /**
     * The constructor.
     */
    public MultiAlignerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MultiAlignerNodePlugin getDefault() {
        return plugin;
    }
}
