 ...
 */
public class XQueryProcessorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.edu.unimelb.plantcell.io.read.xml";

    // The shared instance.
    private static XQueryProcessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public XQueryProcessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static XQueryProcessorNodePlugin getDefault() {
        return plugin;
    }
