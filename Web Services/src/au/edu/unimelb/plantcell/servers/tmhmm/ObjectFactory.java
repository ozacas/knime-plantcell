 ...
 * generated in the au.edu.unimelb.plantcell.servers.tmhmm package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetResultResponseReturn_QNAME = new QName("http://nectar.plantcell.unimelb.edu.au", "return");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.unimelb.plantcell.servers.tmhmm
     * 
     */
    ...
    public JAXBElement<String> createGetResultResponseReturn(String value) {
        return new JAXBElement<String>(_GetResultResponseReturn_QNAME, String.class, GetResultResponse.class, value);
    }
    ...
    public JAXBElement<String> createGetStatusResponseReturn(String value) {
        return new JAXBElement<String>(_GetResultResponseReturn_QNAME, String.class, GetStatusResponse.class, value);
    }
    ...
    public JAXBElement<String> createSubmitResponseReturn(String value) {
        return new JAXBElement<String>(_GetResultResponseReturn_QNAME, String.class, SubmitResponse.class, value);
    }
