 ...
 * generated in the au.edu.unimelb.plantcell.servers.netsurfp package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.unimelb.plantcell.servers.netsurfp
     * 
     */
    ...
    public JAXBElement<String> createGetResultJobID(String value) {
        return new JAXBElement<String>(_GetStatusJobID_QNAME, String.class, GetResult.class, value);
    }
