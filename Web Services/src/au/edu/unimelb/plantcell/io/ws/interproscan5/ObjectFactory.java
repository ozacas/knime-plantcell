 ...
 * generated in the au.edu.unimelb.plantcell.io.ws.interproscan5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _InputParametersPathways_QNAME = new QName("", "pathways");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: au.edu.unimelb.plantcell.io.ws.interproscan5
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "pathways", scope = InputParameters.class)
    public JAXBElement<Boolean> createInputParametersPathways(Boolean value) {
        return new JAXBElement<Boolean>(_InputParametersPathways_QNAME, Boolean.class, InputParameters.class, value);
    }
