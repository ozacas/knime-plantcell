 ...
 * 
 */
@WebServiceClient(name = "JDispatcherService", targetNamespace = "http://soap.jdispatcher.ebi.ac.uk", wsdlLocation = "file:/C:/cygwin/home/andrew.cassin/test.outoftheway/phobius/phobius.wsdl")
public class JDispatcherService_Service
    extends Service
{

    private final static URL JDISPATCHERSERVICE_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(uk.ac.ebi.jdispatcher.soap.phobius.JDispatcherService_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = uk.ac.ebi.jdispatcher.soap.phobius.JDispatcherService_Service.class.getResource(".");
            url = new URL(baseUrl, "file:/C:/cygwin/home/andrew.cassin/test.outoftheway/phobius/phobius.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/cygwin/home/andrew.cassin/test.outoftheway/phobius/phobius.wsdl', retrying as a local file");
