...
class Token
{
  ...
  public static final Token NAMED_RANGE = new Token(0x43, 0x23, 0x63);
  public static final Token NAME        = new Token(0x39);
  public static final Token AREA3D      = new Token(0x3b);
