...
public class NumberFormat extends NumberFormatRecord implements DisplayFormat
{
   ...
   */
  public final static NonValidatingFormat COMPLEX_FORMAT = 
   ...
   * the format
   */
  public final static String CURRENCY_EURO_PREFIX = "[$€-2]";

  /**
   * Constant format string for the Euro currency symbol where it precedes
   * the format
   */
  public final static String CURRENCY_EURO_SUFFIX = "[$€-1]";

  /**
   * Constant format string for the UK pound sign
   */
  public final static String CURRENCY_POUND = "£";

  /**
   * Constant format string for the Japanese Yen sign
   */
  public final static String CURRENCY_JAPANESE_YEN = "[$¥-411]";

  /**
   * Constant format string for the US Dollar sign
   */
  public final static String CURRENCY_DOLLAR = "[$$-409]";

  /**
   * Constant format string for three digit fractions
   */
  public final static String FRACTION_THREE_DIGITS = "???/???";

  /**
   * Constant format string for fractions as halves
   */
  public final static String FRACTION_HALVES = "?/2";

  /**
   * Constant format string for fractions as quarter
   */
  public final static String FRACTION_QUARTERS = "?/4";

  /**
   * Constant format string for fractions as eighths
   */
  public final static String FRACTIONS_EIGHTHS = "?/8";

  /**
   * Constant format string for fractions as sixteenths
   */
  public final static String FRACTION_SIXTEENTHS = "?/16";

  /**
   * Constant format string for fractions as tenths
   */
  public final static String FRACTION_TENTHS = "?/10";

  /**
   * Constant format string for fractions as hundredths
   */
  public final static String FRACTION_HUNDREDTHS = "?/100";
