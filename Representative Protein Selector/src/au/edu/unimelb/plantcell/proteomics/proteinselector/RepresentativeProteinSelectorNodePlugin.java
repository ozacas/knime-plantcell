 ...
 */
public class RepresentativeProteinSelectorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.edu.unimelb.plantcell.proteomics.proteinselector";

    // The shared instance.
    private static RepresentativeProteinSelectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public RepresentativeProteinSelectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RepresentativeProteinSelectorNodePlugin getDefault() {
        return plugin;
    }
