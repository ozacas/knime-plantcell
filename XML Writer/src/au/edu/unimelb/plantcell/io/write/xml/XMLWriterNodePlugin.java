 ...
 */
public class XMLWriterNodePlugin extends Plugin {
    // The shared instance.
    private static XMLWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public XMLWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static XMLWriterNodePlugin getDefault() {
        return plugin;
    }
