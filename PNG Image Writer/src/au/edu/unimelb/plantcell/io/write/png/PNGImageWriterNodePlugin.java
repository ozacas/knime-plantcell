 ...
 *
 */
package au.edu.unimelb.plantcell.io.write.png;
 ...
 */
public class PNGImageWriterNodePlugin extends Plugin {
    // The shared instance.
    private static PNGImageWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public PNGImageWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PNGImageWriterNodePlugin getDefault() {
        return plugin;
    }
