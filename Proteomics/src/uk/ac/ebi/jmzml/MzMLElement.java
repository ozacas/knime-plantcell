...
//    UserParam(                  "userParam",                    false,      null /*multiple locations*/,                                                                    false,      UserParam.class,                    false,         UserParamRefResolver.class);
    ...
    public static void loadProperties() {
        /*
        Logger logger = Logger.getLogger("MzMLElement");
        ...
        logger.warning("MzIdentML Configuration file: " + xmlFileURL.toString());
	*/
       
        try {
        	Bundle bundle = Platform.getBundle("au.edu.unimelb.plantcell.proteomics");
            URL u = FileLocator.find(bundle, new Path("defaultMzMLElement.cfg.xml"), null);

			JAXBContext cb = JAXBContext.newInstance("uk.ac.ebi.jmzml.model.mzml.utilities", MzMLElementProperties.class.getClassLoader());
		
			Unmarshaller um = cb.createUnmarshaller();
			Object o = um.unmarshal(u);
		    Map<String, MzMLElementConfig> localCfg = getCfg();
		    MzMLElementProperties props = (MzMLElementProperties) o;
