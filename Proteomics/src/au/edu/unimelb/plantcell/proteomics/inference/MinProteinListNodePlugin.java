 ...
 */
public class MinProteinListNodePlugin extends Plugin {
    // The shared instance.
    private static MinProteinListNodePlugin plugin;

    /**
     * The constructor.
     */
    public MinProteinListNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MinProteinListNodePlugin getDefault() {
        return plugin;
    }
