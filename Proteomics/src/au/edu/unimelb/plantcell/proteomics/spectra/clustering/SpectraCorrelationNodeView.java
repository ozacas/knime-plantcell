 ...
 */
public class SpectraCorrelationNodeView extends NodeView<SpectraCorrelationNodeModel> {
     ...
     */
    protected SpectraCorrelationNodeView(final SpectraCorrelationNodeModel nodeModel) {
        super(nodeModel);
    ...
    protected void modelChanged() {
        ...
        // update the view.
    	SpectraCorrelationNodeModel nodeModel = 
            (SpectraCorrelationNodeModel)getNodeModel();
