 ...
 */
public class PepXMLReaderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.edu.unimelb.plantcell.io.read.pepxml";

    // The shared instance.
    private static PepXMLReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public PepXMLReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PepXMLReaderNodePlugin getDefault() {
        return plugin;
    }
