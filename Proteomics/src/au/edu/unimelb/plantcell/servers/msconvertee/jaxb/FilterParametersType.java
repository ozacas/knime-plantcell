 ...
 *       &lt;sequence>
 *         &lt;element name="msLevelFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}MsLevelType" maxOccurs="3" minOccurs="0"/>
 *         &lt;element name="peakPicking" type="{http://www.w3.org/2001/XMLSchema}string"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="noiseFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}noiseFilteringType" minOccurs="0"/>
 ...
 *         &lt;element name="scanFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}scanFilterType"/>
 *         &lt;element name="chargeStateFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}chargeStateFilterType"/>
 *         &lt;element name="mzPrecursorFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}mzPrecursorFilterType"/>
 *         &lt;element name="zeroesFilter" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}zeroesFilterType"/>
 *         &lt;element name="ms2denoise" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}MS2DenoiseType"/>
 *         &lt;element name="ms2deisotope" type="{http://www.plantcell.unimelb.edu.au/bioinformatics/schemas/v1/msconvertee}MS2DeisotopeType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FilterParametersType {
    ...
    protected List<MsLevelType> msLevelFilter;
    @XmlElement(required = true)
    protected String peakPicking;
    ...
    protected NoiseFilteringType noiseFilter;
    ...
    @XmlElement(name = "ms2denoise", required = true)
    protected MS2DenoiseType ms2Denoise;
    @XmlElement(name = "ms2deisotope", required = true)
    protected MS2DeisotopeType ms2Deisotope;
     ...
     * This is why there is not a <CODE>set</CODE> method for the msLevelFilter property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMsLevelFilter().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MsLevelType> getMsLevelFilter() {
        if (msLevelFilter == null) {
            msLevelFilter = new ArrayList<MsLevelType>();
        }
        return this.msLevelFilter;
    }
     ...
     *     
     */
    public void setPeakPicking(String value) {
     ...
     * @return
     *     possible object is
     *     {@link NoiseFilteringType }
     *     
     */
    public NoiseFilteringType getNoiseFilter() {
        return noiseFilter;
    }
     ...
     *     
     */
    public void setNoiseFilter(NoiseFilteringType value) {
    ...
    /**
     * Gets the value of the ms2Deisotope property.
     * 
     * @return
     *     possible object is
     *     {@link MS2DeisotopeType }
     *     
     */
    public MS2DeisotopeType getMs2Deisotope() {
        return ms2Deisotope;
    }

    /**
     * Sets the value of the ms2Deisotope property.
     * 
     * @param value
     *     allowed object is
     *     {@link MS2DeisotopeType }
     *     
     */
    public void setMs2Deisotope(MS2DeisotopeType value) {
        this.ms2Deisotope = value;
    }
