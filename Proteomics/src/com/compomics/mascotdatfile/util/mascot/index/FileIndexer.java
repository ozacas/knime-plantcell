...
public class FileIndexer {
    ...
    private SummaryIndex iSummaryIndex = new SummaryIndex();
    private SummaryIndex iDecoySummaryIndex = new SummaryIndex();
	...
	public SummaryIndex getSummaryIndex() {
		return iSummaryIndex;
	}

	public SummaryIndex getDecoySummaryIndex() {
		return iDecoySummaryIndex;
	}
}
